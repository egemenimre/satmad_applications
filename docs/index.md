...
Check the source code of [SatMAD](https://github.com/egemenimre/satmad). The applications are under
[this project](https://github.com/egemenimre/satmad_applications).
